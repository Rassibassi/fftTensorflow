...
errorAfter = np.mean(np.power(np.abs(out_signal-signal),2))
errorBefore = np.mean(np.power(np.abs(out_signal_f-signal_f),2))
print('Error before fft:',errorAfter)
print('Error after fft:',errorBefore)